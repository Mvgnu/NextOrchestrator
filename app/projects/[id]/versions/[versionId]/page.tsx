...
export default function VersionViewPage() {
  ...
  const handleVersionHistoryClick = () => {
    if (version) {
      ...
      if (contentType === 'context') {
        router.push(
          `/projects/${projectId}/contexts/${version.content_id}/versions`,
        )
      } else if (contentType === 'agent') {
        router.push(
          `/projects/${projectId}/agents/${version.content_id}/versions`,
        )
      }
    }
  }
    ...
    <div className="container max-w-4xl py-6">
      <div className="flex items-center justify-between mb-6">
        ...
        >
          ...
          Back to{' '}
          {version.content_type.charAt(0).toUpperCase() +
            version.content_type.slice(1)}
        </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="mt-2 space-y-1 text-sm">
              <p>
                <span className="font-medium">ID:</span> {version.id}
              </p>
              <p>
              ...
              <p>
                <span className="font-medium">Is Current:</span>{' '}
      ...
      <div className="mb-6">
        ...
        <Card className="p-6">
          {contentSnapshot.content ? (
            contentSnapshot.content.length > 10000 ? (
      ...
      <Dialog open={confirmRestore} onOpenChange={setConfirmRestore}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to restore this version? This will make it
              the current version.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
